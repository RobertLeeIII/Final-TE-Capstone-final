    ...
    <div class="container">
      <section class="requested-items">
        ...
        <div class="requested-items-details">
          <router-link :to="{ name: 'dish-signup', params: { potluckId: this.$route.params.potluckId }, query: { action: 'signup', course: 1 } }">
            <div class="requested-item">
              <span>{{ Potluck.courseRequest.apps }} Appetizers</span>
            </div>
          </router-link>
          <router-link :to="{ name: 'dish-signup', params: { potluckId: this.$route.params.potluckId }, query: { action: 'signup', course: 2 } }">
            <div class="requested-item">
              <span class="host-request">{{ Potluck.courseRequest.sides }} Sides</span>
            </div>
          </router-link>
          <router-link :to="{ name: 'dish-signup', params: { potluckId: this.$route.params.potluckId }, query: { action: 'signup', course: 3 } }">
            <div class="requested-item">
              <span>{{ Potluck.courseRequest.mains }} Main Dishes</span>
            </div>
          </router-link>
          <router-link :to="{ name: 'dish-signup', params: { potluckId: this.$route.params.potluckId }, query: { action: 'signup', course: 4 } }">
            <div class="requested-item">
              <span>{{ Potluck.courseRequest.desserts }} Desserts</span>
            </div>
          </router-link>
        </div>
        <router-link :to="{ name: 'dish-signup', params: { potluckId: this.$route.params.potluckId } }"><button>Bring a
